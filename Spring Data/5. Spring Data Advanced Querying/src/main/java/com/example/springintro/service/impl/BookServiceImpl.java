...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllTitlesAndPricesOfBooksWherePriceIsLowerThan5AndHigherThan40() {
    ...
    @Override
    public List<String> findAllBookTitlesWhereBooksAreNotReleasedInTheGivenYear(int year) {
    ...
    @Override
    public List<String> findBookInfoWhereBookIsReleasedBeforeGivenDate(LocalDate localDate) {
    ...
    @Override
    public List<String> findAllBooksTitlesWhichContainsAGivenChars(String chars) {
        return bookRepository
                .findAllByTitleContains(chars)
                .stream().map(Book::getTitle)
                .collect(Collectors.toList());
    }

    @Override
    public List<String> findAllBookTitlesWrittenByAuthorsWithLastNameChars(String charsInput) {
        return bookRepository.findAllByAuthor_LastNameStartsWith(charsInput)
    ...
    @Override
    public int findAllCountOfAllBooksWhichTitleLengthIsMoreThanInputNumber(int number) {
        return bookRepository.countOfBooksWithTitleLengthMoreThan(number);
    }

    @Override
    public List<String> findTitleTypeAgeAndPriceOfGivenBookTitle(String bookTitle) {
        return bookRepository
